...
import { chatEntityDetailScreen, chatEntityEditScreen } from '../../../navigation/layouts'
import ChatActions from './chat.reducer'
import styles from './chat-entity-screen-style'
import AlertMessage from '../../../shared/components/alert-message/alert-message'

// More info here: https://facebook.github.io/react-native/docs/flatlist.html

class ChatEntityScreen extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  navigationButtonPressed({ buttonId }) {
    chatEntityEditScreen({ entityId: null })
  }
  /* ***********************************************************
  * STEP 2
  ...
  *************************************************************/
  ...
  renderEmpty = () => <AlertMessage title="No Chats Found" show={!this.props.fetching} />
...
const mapStateToProps = state => {
  return {
    ...
    fetching: state.chats.fetchingAll,
    error: state.chats.errorAll,
  }
}
